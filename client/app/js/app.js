  ...
  ['$routeProvider',
   function ( $routeProvider )
   {
     ...
     $routeProvider.when( '/projects',
                          {controller: 'ProjectCtrl', templateUrl: 'partials/project/list.html'} );
     $routeProvider.when( '/project/new',
                          {controller: 'ProjectCtrl', templateUrl: 'partials/project/new.html'} );
     $routeProvider.when( '/users',
                          {controller: 'UserCtrl', templateUrl: 'partials/user/list.html'} );
     $routeProvider.when( '/user/new',
                          {controller: 'UserCtrl', templateUrl: 'partials/user/new.html'} );
     $routeProvider.when( '/user/edit/:userId',
                          {controller: 'UserEditCtrl', templateUrl: 'partials/user/edit.html'} );
